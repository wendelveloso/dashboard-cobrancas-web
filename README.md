...
# Desafio Final- PARTE FRONTEND

- Este repositório deverá servir de base para ser realizado o fork para desenvolvimento da parte de **FRONTEND** do desafio. O desafio deve ser feito utilizando o [`vite`](https://vitejs.dev/) como templete para o [`react`](https://react.dev/) podendo ser feito com arquivos em `Javascript` ou `Typescript` ou com [`Next`](https://nextjs.org/), ficando a sua escolha.

- O repositorio contem o projeto inicial contendo o cadastro de usuarios e login junto com os arquivos de estilização

- Você tambem pode escolher como vai ser feito a estilização do projeto podendo utilizar `css` ou [`sass`](https://sass-lang.com/).

- Caso escolha realizar o projeto em [`Next`](https://nextjs.org/) deve ser adaptado o molde desde o começo do projeto por conta das diferenças de estrutura que tem em comparação ao [`react`](https://react.dev/) (o desafio pode ser feito e consegue chegar ao mesmo resultado independente da escolha final)

- Deploy do projeto pode ser feito no site [`netlify`](https://www.netlify.com/) ou [`vercel`](https://vercel.com/docs/deployments/overview), tambem pode ser realizado em em algum outro similar a sua escolha.
---
...
- <b>Critérios de aceite</b>
  ...
  - O backend e banco de dados deverá ser hospedado na <b>heroku</b> OU deploys semelhantes ficando a sua escolha
